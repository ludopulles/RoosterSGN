...
import eu.ludiq.sgn.rooster.net.HttpCallback;
import eu.ludiq.sgn.rooster.net.HttpRequest;
import eu.ludiq.sgn.rooster.net.HttpUtils;
import eu.ludiq.sgn.rooster.net.TimetableRequest;
import eu.ludiq.sgn.rooster.rooster.Timetable;
import eu.ludiq.sgn.rooster.scroll.ViewFlipperCompat;
import eu.ludiq.sgn.rooster.ui.DateView;
import eu.ludiq.sgn.rooster.ui.MenuView;
import eu.ludiq.sgn.rooster.ui.MenuView.MenuClickListener;
import eu.ludiq.sgn.rooster.ui.ViewFlipperManager;
import eu.ludiq.sgn.rooster.util.DataStorage;
import eu.ludiq.sgn.rooster.util.DayUtil;
import eu.ludiq.sgn.rooster.util.RefreshAnimation;
